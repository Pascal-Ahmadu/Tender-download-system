    ...
    >
      <Box
        sx={{
          ...
          border: "1px solid #dbe1e6", // Add border
          borderRadius: 2, // Rounded corners
          padding: 2, // Add padding inside the border
          boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)", // Optional: Add shadow for a subtle lift effect
        }}
      >
        <Typography
          variant="h4"
        ...
        <Button
          ...
          sx={{
            ...
            mt: 3, // Add margin-top to push the button down
